        ...
        <div class="register">
          ...
          <form id="reg-form" action="set_profile.php" method="post">
            ...
            <div>
              ...
              <input type="number" div id='mem1' name="age" id="date" spellcheck="false" placeholder="Age" min='18' max='80' size="80" required="required"/>
            </div>
 <div>
  ...
  <input type="radio" name="gender" value="other"> Other
            ...
            <div>
              ...
              <input type="text" name="cast"id="cast" spellcheck="false" placeholder="Enter Cast" required="required" pattern=[a-zA-Z]{2,}  title="Please Enter Alphabets"/>
            </div>
            <div>
              <label for="community">Community*:</label>
              <input type="text" name="community"id="community" spellcheck="false" placeholder="Enter Community" required="required" pattern="[a-zA-Z]{2,}" title="Please Enter Alphabets" />
            </div>
            <div>
              <label for="qualification">Qualification*:</label>
              <input type="text" name="qualification" id="qualification"  spellcheck="false" placeholder="qualification" required="required" pattern=[a-zA-Z]{2,}  title="Please Enter Alphabets" />
            </div>

                        <div>
              <label for="income">Income*:</label>
              <input type="number" div id='mem1' name="income" id="income" spellcheck="income" placeholder="Enter Income" required="required" min="10000" max="200000000"/>
            </div>
                        <div>
              <label for="profession">Profession*:</label>
              <input type="text" name="profession" id="profession" spellcheck="false" placeholder="Enter Profession" required="required" pattern=[a-zA-Z]{2,}  title="Please Enter Alphabets"/>
            </div>
                        <div>
              <label for="location">Location*:</label>
              <input type="text" name="location" id="location" spellcheck="false" placeholder="Enter Location" required="required" pattern=[a-zA-Z]{2,}  title="Please Enter Alphabets"/>
            </div>
                        <div>
              ...
              <input type="text" name="contact_no" id="contact_no" spellcheck="false" placeholder="Contact_no" required="required"pattern="[789][0-9]{9}"/>
		      	...
		      	<input type="text" name="color" id="color" name="color" value="" placeholder="Face color" tabindex="2" required="required" pattern=[a-zA-Z]{2,}  title="Please Enter Alphabets"/>
		      </div>

             <div>		          
		    
		      <label for="required" required="required">Member status*: </label>
			      <select id="member_status" name="member_status" tabindex="4" required="required">   
					  <option value="">select</option>
			         <option div id='mem'>Premium</option>
			          <option div id='mem'>Non-premium</option>
			      </select>
			...
			<div>		          
		      ...
		      <label for="marital_status">Marital Status*: </label>
			      <select id="marital_status" name="marital_status" tabindex="4" required="required">   
					  <option value="">select</option>
			         <option div id='mem'>Single</option>
			          <option div id='mem'>Divorced</option>
			           <option div id='mem'>Widower</option>
			         <option div id='mem'>Widow</option>  
			...
			<div>		          
		      ...
		      <label for="height">Height(In Foot)*: </label>
			      <select id="height" name="height" tabindex="4" required="required"> 
					  <option value="">select</option>
			         <option div id='mem'>4</option> 
			         <option div id='mem'>4.5</option> 
			         <option div id='mem'>5</option> 
			         <option div id='mem'>5.5</option>
			         <option div id='mem'>6</option> 
			         <option div id='mem'>6.5</option> 
			         <option div id='mem'>7</option>  
