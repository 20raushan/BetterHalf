...
<head>
 ...
 <body>
	<div id="header_to_view_profile"><center><a href="user_portal.php" id="home_logo" style="text-decoration:none"><font color="white" size="6px" face="Times new roman" >BETTER-HALF</font></a></center> </div>
...
if($var->num_rows > 0)
{
	...
	while($row=$var->fetch_assoc())
	{
		...
		"</td></tr><tr><td>SEX:-</td><td>".$row['gender'].
