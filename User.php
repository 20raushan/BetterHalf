...
class User {
    ...
    private $dbUsername = "id1220508_betterhalf";
    private $dbPassword = "betterhalf";
    private $dbName     = "id1220508_betterhalf";
    ...
    function checkUser($userData = array()){
        if(!empty($userData)){
            ...
            if($prevResult->num_rows > 0){
                ...
                //Insert user data
                $query = "INSERT INTO ".$this->userTbl." SET user_id = '".$userData['email']."', first_name = '".$userData['first_name']."', last_name = '".$userData['last_name']."',income='0',age='0',height='0'";
