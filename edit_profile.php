      ...
      echo   '<h3>Edit your profile</h3>';
       echo  '<form id="reg-form" action="edit_profile.php" method="post">';
         echo   "<div>";
             ...
             echo "<input type='text' name='fname' id='fname' pattern='[a-zA-Z]{2,}'   title='Please Enter Alphabets' required='required' value=".$abc['first_name']. " >";
          echo  "</div>";
          echo   "<div>";
             echo  '<label for="name">Last Name:</label>';
             echo "<input type='text' name='lname' required='required' id='lname' pattern='[a-zA-Z]{2,}' title='Please Enter Alphabets' value=".$abc['last_name']." >";
          echo  "</div>";
			
			
        echo  "<div>";
         	echo  '<label for="cast">cast:</label>';
            echo   "<input type='text' required='required' name='cast' id='cast' pattern='[a-zA-Z]{2,}'  title='Please Enter Alphabets' value=".$abc['cast']. " >";
        echo  "</div>";
		
		echo "<div>";
        	echo '<label for="gender">Gender:</label>';
         	echo  "<input type='text' required='required' name='gender' id='gender' pattern='[a-zA-Z]{2,}' title='Please Enter Alphabets' value=".$abc['gender'] . " >";
        echo  "</div>";
        echo " <div >";
              echo '<label for="age">Age:</label>';
              echo "<input type='number' required='required' name='age' id='age' min='18' max='80' value=".$abc['age'] .">";
        echo "</div>";
        echo   "<div>";
          echo    '<label for="community">Community:</label>';
          echo    "<input type='text' required='required' name='community' pattern='[a-zA-Z]{2,}'  title='Please Enter Alphabets' value=" .$abc['community']. " >";
        echo  "</div>";
        echo   "<div>";
            echo   '<label for="qualification">Qualification:</label>';
          	echo    "<input type='text' required='required' name='qualification' pattern='[a-zA-Z]{2,}' title='Please Enter Alphabets'  value=".$abc['qualification']." >";
        echo  "</div>";
        echo   "<div>";
            echo    '<label for="income">Income:</label>';
            echo    "<input type='number' required='required' name='income' id='income' min='10000' max='20000000' value=".$abc['income'] ." >";
        echo  "</div>";
        echo  "<div>";
            echo    '<label for="profession">Profession:</label>';
            echo    "<input type='text' required='required' name='profession'pattern='[a-zA-Z]{2,}'  title='Please Enter Alphabets' value=".$abc['profession']. " >";
        echo  "</div>";
        echo  "<div>";
            echo   '<label for="location">Location:</label>';
            echo   "<input type='text' required='required' name='location'  pattern='[a-zA-Z]{2,}' title='Please Enter Alphabets' value=".$abc['location'] ." >";
        echo  "</div>";
        echo  "<div>";
            echo  '<label for="contact">Contact_No:</label>';
            echo    "<input type='text' required='required' name='contact_no' id='contact_no'value=".$abc['contact_no']. " >";
        echo  "</div>";
        echo  "<div>";
		     echo    '<label for="required">Color: </label>';
		     echo   	"<input type='text' name='color' id='color'  required='required'pattern='[a-zA-Z]{2,}'   title='Please Enter Alphabets' value=".$abc['color']." >";
		echo  "</div>";
		echo  "<div>";		          
		    
		       echo   '<label for="required">Member status: </label>';
			   echo    "<select id='member_status' name='member_status' required='required' value=".$abc['membership_status']." required='required' >"; 
		...
		echo  "<div>";		          
		       ...
		       echo   '<label for="required">Marital Status: </label>';
		  	   echo    "<select id='marital_status' name='marital_status' required='required' value=".$abc['marital_status']." required='required' >"; 
			   echo      "<option > select </option>";			 
		...
		echo	"<div>	";	          
			   ...
			   echo  "<select id='height' required='required' name='height'  value=" .$abc['height']." required='required' >";
			   echo      "<option >  select </option>";
        ...
        echo  "<div>";
		   echo "<center><input type='submit' name='save_profile' value='Save Profile' id='save_profile' >";
        echo "</div>";
